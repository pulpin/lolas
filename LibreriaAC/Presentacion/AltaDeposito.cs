    ...
    public partial class AltaDeposito : Form
    {
        ...
        private void Altadeposito()
        {
            ...
            if (resultado == 0)
            {
                ...
                MessageBox.Show("Se ha guardado el stock en el depósito!");
            }
            else
            {
        ...
        private void AltaProducto_Load(object sender, EventArgs e)
        {
            ...
            lUTipoajuste.Properties.DisplayMember = "LUD_DESC";
            lUTipoajuste.Properties.ValueMember = "LUD_IDE";
            lUTipoajuste.Properties.DataSource = dep.Tabladedatos_depositos();
