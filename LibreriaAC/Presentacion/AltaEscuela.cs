...
namespace Presentacion
{
    public partial class AltaEscuela : Form
    {
        ...
        private void btnagregar_Click(object sender, EventArgs e)
        {
            ...
            {
                this.modificaEscuela();
            }
        }

        public void colocardatosEdi()
        {
            txescuela.Text = this.Titulo;
        ...
        private void AltaEscuelas()
        {
            Genero gen = new Genero();
            Adopcion ado = new Adopcion();
            ado.Titulo = (txescuela.Text).ToUpper();
            //gen.Titulo = txteditorial.Text;
           
            gen.Alta = 1;
            int resultado = ado.spAgregarEscuela();
            if (resultado == 0)
            {
                this.DialogResult = System.Windows.Forms.DialogResult.OK;
                MessageBox.Show("Se ha guardado creado la escuela!");
            }
            else
            {
        ...
        private void modificaEscuela()
        {
            
            Adopcion ado = new Adopcion();
            ado.Titulo = txescuela.Text;
            ado.Alta = 0;
            ado.Ide = this.Ide;
            ...
            {
                this.DialogResult = System.Windows.Forms.DialogResult.OK;
                MessageBox.Show("Se ha Modificado la Escuela!");
            }
            else
            {
                MessageBox.Show("Se ha producido un error!");
        ...
        {
            this.txescuela.Text = this.Nombre;
