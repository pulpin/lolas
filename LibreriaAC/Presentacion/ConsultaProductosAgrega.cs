...
{
    public partial class ConsultaProductosAgrega : Form
    {
        ...
        int _alta;
        public ConsultaProductosAgrega()
        {
            InitializeComponent();
        ...
        private void cargarcanti()
        {
            ...
            if (cc.ShowDialog() == System.Windows.Forms.DialogResult.OK)
            {
                ...
                IForm formdeInterface1 = this.Owner as IForm;
                if (formdeInterface1 != null)
                {
                    ...
                    formdeInterface1.AgregarProducto(rowsenviar, Convert.ToDouble(subtotal), ivavalor, importedeliva, iva, Convert.ToInt32(cantidadelegida));
                }
