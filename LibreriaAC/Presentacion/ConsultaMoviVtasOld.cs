...
{
    public partial class ConsultaMoviVtasOld : Form
    {
        string _codigo;
        Venta ven = new Venta();
        public ConsultaMoviVtasOld()
        {
            InitializeComponent();
        }
        ...
        private void cargar()
        {
            ...
            gConsulta.DataSource = ven.Mostrar_registrodelasventasOld();

            gConsulta1.DataSource = ven.Mostrar_movimientosdeproductosOld();
