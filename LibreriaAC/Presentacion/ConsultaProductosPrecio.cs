        ...
        private void recorrergrilla()
        {
            ...
            for (int i = 0; i < gridViewPintarFilas.DataRowCount; i++)
            {
               ...
               // {
                    ...
                    int codigo = Convert.ToInt32(this.gridViewPintarFilas.GetRowCellValue(i, this.gridViewPintarFilas.Columns["LI_IDE"]));
                    string costop = Convert.ToString(this.gridViewPintarFilas.GetRowCellValue(i, this.gridViewPintarFilas.Columns["LI_COSTO"]));
                    string gananciap = Convert.ToString(this.gridViewPintarFilas.GetRowCellValue(i, this.gridViewPintarFilas.Columns["LI_PORC_GANAN"]));
                    string ivap = Convert.ToString(this.gridViewPintarFilas.GetRowCellValue(i, this.gridViewPintarFilas.Columns["LI_PORC_IVA"]));
                    decimal costo = Convert.ToDecimal(costop.Replace(".", ","));
                    decimal ganancia = Convert.ToDecimal(gananciap.Replace(".", ","));
                    decimal iva = Convert.ToDecimal(ivap.Replace(".", ","));

                int valor = pro.SetearPrecioNuevo(codigo, costo,ganancia,iva, Convert.ToInt32(txtporcentaje.Text));
            ...
            {
                gConsulta.DataSource = re.Mostrar_pedidosporeditorial(editorialesa);
            }*/
        }
    }
