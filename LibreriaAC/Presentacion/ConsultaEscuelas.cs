...
{
    public partial class ConsultaEscuelas : Form
    {
        Editorial edi = new Editorial();
        Adopcion ado = new Adopcion();
        public ConsultaEscuelas()
        {
            InitializeComponent();
        }
        ...
        private void cargar()
        {
            ...
            gConsulta.DataSource = ado.Tabladedatos_adopcionEscuelas();
        ...
        private void btnaltacliente_Click(object sender, EventArgs e)
        {
            ...
            AltaEscuela ae = new AltaEscuela();
            ae.Alta = 1;
        ...
        {
            if (MessageBox.Show("¿Desea eliminar ésta Escuela?", "Eliminación", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == System.Windows.Forms.DialogResult.Yes)
            {

                ado.Ide = Convert.ToInt32(this.gridViewPintarFilas.GetRowCellValue(gridViewPintarFilas.FocusedRowHandle, this.gridViewPintarFilas.Columns["esc_ide"]));
                ado.Alta = -1;
                int valor = ado.spAgregarEscuela();
        ...
        private void btnmodificar_Click(object sender, EventArgs e)
        {
            ...
            AltaEscuela ae = new AltaEscuela();
            ae.Alta = 0;
            ae.Ide = Convert.ToInt32(this.gridViewPintarFilas.GetRowCellValue(gridViewPintarFilas.FocusedRowHandle, this.gridViewPintarFilas.Columns["esc_ide"]));
            ae.Titulo = Convert.ToString(this.gridViewPintarFilas.GetRowCellValue(gridViewPintarFilas.FocusedRowHandle, this.gridViewPintarFilas.Columns["esc_desc"]));
            ae.colocardatos();
