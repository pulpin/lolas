...
namespace Presentacion
{
    public partial class ModificarFactura : Form
    {
        ...
        private void Altapago()
        {
            ...
            int resultado = ado.spModificaFactu();
            
            if (resultado == 0)
            {
                MessageBox.Show("Se ha realizado la modificación de la factura!");
