...
namespace Presentacion
{
    public partial class AltaGenero : Form
    {
        ...
        private void Altagenero()
        {
            Genero gen = new Genero();
            //gen.Titulo = (txteditorial.Text).ToUpper();
            ...
            gen.Alta = 1;
            int resultado = gen.spAgregarGenero();
            if (resultado == 0)
            {
                this.DialogResult = System.Windows.Forms.DialogResult.OK;
                MessageBox.Show("Se ha guardado creado el género!");
            }
            else
            {
        ...
        private void modificaGenero()
        {
            ...
            int resultado = gen.spModificarGenero();
            if (resultado == 0)
            {
                this.DialogResult = System.Windows.Forms.DialogResult.OK;
                MessageBox.Show("Se ha Modificado el Género!");
            }
            else
            {
                MessageBox.Show("Se ha producido un error!");
