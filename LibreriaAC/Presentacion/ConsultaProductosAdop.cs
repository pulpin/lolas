...
{
    public partial class ConsultaProductosAdop : Form
    {
        Editorial edi = new Editorial();
        Productos pro = new Productos();
        Genero gen = new Genero();
        ToolTip tol = new ToolTip();
        int _alta, _adopciones;
        public ConsultaProductosAdop()
        {
            InitializeComponent();
        ...
        private void cargardatos()
        {
            ...
            if (Convert.ToInt32(this.gridViewPintarFilas.GetRowCellValue(gridViewPintarFilas.FocusedRowHandle, this.gridViewPintarFilas.Columns["LI_INVENTA"])) == 1)
            {
                ...
                lbinventario.Text = fechainventa.ToShortDateString();
            }
        ...
        private void cargarcanti()
        {
            ...
            string cod = Convert.ToString(this.gridViewPintarFilas.GetRowCellValue(gridViewPintarFilas.FocusedRowHandle, this.gridViewPintarFilas.Columns["LI_CODIGO"]));
            CargarProAdo cc = new CargarProAdo();
            cc.Liide = pro.productoide;
            cc.Titulo = nombre;
            cc.Codigo = cod;
            cc.Adopide = this.Adopcione;
            cc.colocartitulo();
        ...
        public int Adopcione
        {
            get { return this._adopciones; }
            set { this._adopciones = value; }
        }
