...
{
    public partial class ConsultasLugares : Form
    {
        string _codigo;
        Deposito dep = new Deposito();
        public ConsultasLugares()
        {
            InitializeComponent();
        }
        ...
        private void cargar()
        {
            dep.Codigo = this.Codigo;
            gConsulta.DataSource = dep.Mostrar_depositodetalle();
        }
        ...
        {
            ConsultasLugaresABM cla = new ConsultasLugaresABM();
            cla.ShowDialog();
        }
    }
}
