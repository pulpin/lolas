...
{
    public partial class ConsultasRendicionesD : Form
    {
        string _codigo, senores, domi, dominro;
        Rendiciones ren = new Rendiciones();
        public ConsultasRendicionesD()
        {
            InitializeComponent();
        }
        ...
        private void cargar()
        {
            ...
            gConsulta.DataSource = ren.Mostrar_rendicionesdetallesinagru();
