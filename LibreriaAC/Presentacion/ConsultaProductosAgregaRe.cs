...
{
    public partial class ConsultaProductosAgregaRe : Form
    {
        Editorial edi = new Editorial();
        Productos pro = new Productos();
        Genero gen = new Genero();
        ToolTip tol = new ToolTip();
        public ConsultaProductosAgregaRe()
        {
            InitializeComponent();
        }
        ...
        {
            string tituloi, precioi, autori, codigointernoedii, editoriali, isbni, barrai,codigoproducto;
            ...
            editoriali = Convert.ToString(this.gridViewPintarFilas.GetRowCellValue(gridViewPintarFilas.FocusedRowHandle, this.gridViewPintarFilas.Columns["EDI_EDITORIAL"]));
            barrai = Convert.ToString(this.gridViewPintarFilas.GetRowCellValue(gridViewPintarFilas.FocusedRowHandle, this.gridViewPintarFilas.Columns["LI_BARRA"]));
            codigoproducto = Convert.ToString(this.gridViewPintarFilas.GetRowCellValue(gridViewPintarFilas.FocusedRowHandle, this.gridViewPintarFilas.Columns["LI_CODIGO"]));
            IagregaReserva formdeInterface1 = this.Owner as IagregaReserva;
                if (formdeInterface1 != null)
                {
                formdeInterface1.AgregaProductoR(tituloi, precioi, autori, codigointernoedii, editoriali, barrai,codigoproducto);
                }
